...
issue is rejected by the issue-form gate after the claim inside the pinned
worktree but before driver dispatch; the driver does not re-check that queue rule
