...
- Every hand-written entry carries the narrowest valid condition, preferably `typeReached`, on a type reached before the access occurs; a later or merely related class is not a valid condition. §root/FS-test-contract.3.5
- Do not delete or weaken the tests from the previous step. The hand-written entry supplements the test, it does not replace it. §root/FS-test-contract.1.5
