...
- Modify only the test file and any reachability metadata needed for reporter-requested metadata. Update build.gradle only if changes need adding missing dependencies on classpath, or adding runtime args.
