...
navigation guidance (§CC-code-coverage-improvement).
"""
...
#: (§CC-code-coverage-improvement.4.1).
...
def _universe_ids(
    ...
    overlap would double count (§CC-code-coverage-improvement.4.1).
    """
...
def _run_coverage(
    ...
    the run's gain (§CC-code-coverage-improvement.4.1).
    """
