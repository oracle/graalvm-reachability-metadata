...
The iterative engine (§WF-dynamic-access-iterative) depends on these
...
def compute_class_delta(
    ...
    covered and still-uncovered call sites (§WF-dynamic-access-iterative).
    """
