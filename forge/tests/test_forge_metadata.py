...
class PullRequestReviewTests(unittest.TestCase):
    ...
    def test_rerun_failed_pull_request_workflow_jobs_reruns_failures_under_attempt_limit(self) -> None:
        workflow_runs = [
            ...
            {"id": 104, "conclusion": "cancelled", "run_attempt": 1},
            {"id": 105, "conclusion": "success", "run_attempt": 1},
            {"id": 106, "conclusion": None, "run_attempt": 1},
        ]
        ...
        self.assertEqual(
            ...
            [
                ...
                call(
                    ...
                    "--method",
                    "POST",
                    f"/repos/{forge_metadata.REPO}/actions/runs/104/rerun-failed-jobs",
                ),
            ],
        )
