...
class PublisherTests(unittest.TestCase):
    ...
    def test_body_reports_phase_totals(self) -> None:
        ...
        self.assertIn("Sampled PGO is navigation evidence only", body)
        self.assertIn("| Sampling contexts | 2 | 3 |", body)
        self.assertIn("| Sampled methods | 5 | 8 |", body)
        self.assertIn("| Samples | 42 | 84 |", body)
        self.assertIn("| Sampled/static joins | 2 | 4 |", body)
