...
- Do not accept newly added JDK 21 test overrides or JDK 21-only flags, including `JavaLanguageVersion.of(21)`, `jvmToolchain(21)`, `kotlinOptions.jvmTarget = "21"`, `options.release = 21`, and `-Djava.security.manager=allow`.
