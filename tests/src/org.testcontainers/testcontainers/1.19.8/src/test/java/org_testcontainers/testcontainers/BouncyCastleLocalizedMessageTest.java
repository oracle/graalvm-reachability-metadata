...
import org.testcontainers.shaded.org.bouncycastle.i18n.LocalizedMessage;

import static org.assertj.core.api.Assertions.assertThat;

public class BouncyCastleLocalizedMessageTest {
    private static final String BUNDLE = "org_testcontainers.testcontainers.messages";

    @Test
    void resolvesMessagesWithDefaultAndExplicitClassLoaders() {
