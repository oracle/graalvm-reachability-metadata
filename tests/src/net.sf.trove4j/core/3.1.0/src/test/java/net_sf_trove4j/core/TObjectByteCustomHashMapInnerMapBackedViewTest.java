...
public class TObjectByteCustomHashMapInnerMapBackedViewTest {
    @Test
    void keySetToArrayCreatesTypedArrayWhenProvidedArrayIsTooSmall() {
        TObjectByteCustomHashMap<String> map = new TObjectByteCustomHashMap<>(new CaseInsensitiveStrategy());
