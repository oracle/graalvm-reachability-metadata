...
public class OrgXmlSaxHelpersSecuritySupport12Anonymous4Test {
    ...
    private static final String RESOURCE_NAME =
            "xerces/xmlParserAPIs/sax-helpers-security-support12-anonymous4-resource.txt";
    private static final String RESOURCE_CONTENT =
            "resource loaded through SAX helpers SecuritySupport12 anonymous action";
    private static final String SYSTEM_RESOURCE_NAME =
            "xerces/xmlParserAPIs/sax-helpers-security-support12-system-resource.txt";
    private static final String SYSTEM_RESOURCE_CONTENT =
            "system resource loaded through SAX helpers SecuritySupport12 anonymous action";
    ...
    private static URLClassLoader newXmlParserApisClassLoader() throws Exception {
        return new XmlParserApisClassLoader(
                ...
                OrgXmlSaxHelpersSecuritySupport12Anonymous4Test.class.getClassLoader());
    }
    ...
    private static Optional<Path> findInstrumentedClasses() throws Exception {
        ...
        try (Stream<Path> paths = Files.find(
                ...
                6,
                (path, attributes) -> path.endsWith("org/xml/sax/helpers/SecuritySupport12.class"))) {
    ...
    private static Optional<Path> testProjectBuildDirectory() throws Exception {
        URL codeSource = OrgXmlSaxHelpersSecuritySupport12Anonymous4Test.class
                .getProtectionDomain()
                .getCodeSource()
                .getLocation();
