...
public class JavaxXmlTransformSecuritySupport12Anonymous4Test {
    ...
    private static final String MISSING_RESOURCE_NAME = "xerces/xmlParserAPIs/"
            + "missing-transform-security-support12-resource.txt";
    ...
    private static File findXmlParserApisJar(ClassNotFoundException originalException) throws Exception {
        ...
        Enumeration<URL> resources = classLoader.getResources("javax/xml/transform/SecuritySupport12.class");
    ...
    private static final class ResourceClassLoader extends ClassLoader {
        private ResourceClassLoader() {
            super(JavaxXmlTransformSecuritySupport12Anonymous4Test.class.getClassLoader());
        }

        @Override
        public InputStream getResourceAsStream(String name) {
            if (RESOURCE_NAME.equals(name)) {
                byte[] resourceBytes = "transform security support 12 resource".getBytes(StandardCharsets.UTF_8);
