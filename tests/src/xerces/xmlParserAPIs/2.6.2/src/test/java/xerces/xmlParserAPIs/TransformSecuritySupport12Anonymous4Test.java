...
public class TransformSecuritySupport12Anonymous4Test {
    private static final String SECURITY_SUPPORT_CLASS = "javax.xml.transform.SecuritySupport";
    private static final String SECURITY_SUPPORT12_CLASS = "javax.xml.transform.SecuritySupport12";
    private static final String RESOURCE_NAME = "xerces/xmlParserAPIs/transform-security-support12-resource.txt";
    private static final String RESOURCE_CONTENT = "resource loaded by transform SecuritySupport12 anonymous action";
    private static final String SYSTEM_RESOURCE_NAME =
            "xerces/xmlParserAPIs/transform-security-support12-system-resource.txt";
    private static final String SYSTEM_RESOURCE_CONTENT =
            "system resource loaded by transform SecuritySupport12 anonymous action";
    ...
    private static Object getSecuritySupport12(ClassLoader classLoader) throws Exception {
        ...
        Object securitySupport = invoke(getInstance, null);
        assertThat(securitySupport.getClass().getName()).isEqualTo(SECURITY_SUPPORT12_CLASS);
    ...
    private static Optional<Path> testProjectBuildDirectory() throws Exception {
        URL codeSource = TransformSecuritySupport12Anonymous4Test.class
                .getProtectionDomain()
                .getCodeSource()
                .getLocation();
    ...
    private static InputStream invokeForInputStream(Method method, Object target, Object... arguments)
            throws Exception {
    ...
    private static final class XmlParserApisClassLoader extends URLClassLoader {
        ...
        protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
            if (name.startsWith("javax.xml.transform.")) {
