...
public class ChainedRelMetadataProviderInnerChainedInvocationHandlerTest {
    @SuppressWarnings("deprecation")
    @Test
    void invokesFirstMetadataInstanceWithResult() {
        ...
        assertThat(metadata.rel()).isSameAs(values);
