...
public class ParameterProcessorTest {
    ...
    @Test
    void appliesMultipartFormParameterName() {
    ...
    public static final class FormParamAnnotation implements FormParam {
    ...
    public static final class FormDataParamAnnotation implements FormDataParam {
        private final String value;
    ...
    public static final class PathParamAnnotation implements PathParam {
        private final String value;
