...
public class LinkedHashSetInneranonfunInnerwriteObjectAnonymous1Test {

    @Test
    void serializesLinkedSetElementsInInsertionOrder() throws Exception {
        ...
        assertThat(serializedStrings).containsExactly("alpha", "beta");
    }
