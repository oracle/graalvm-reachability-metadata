...
public class ParHashMapInneranonfunInnerwriteObjectAnonymous1Test {

    @Test
    void serializesEveryParallelMapKeyAndValue() throws Exception {
        ParHashMap<String, String> original = new ParHashMap<>();
