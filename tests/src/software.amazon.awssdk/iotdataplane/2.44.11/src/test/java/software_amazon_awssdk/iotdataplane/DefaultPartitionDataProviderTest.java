...
public class DefaultPartitionDataProviderTest {
    ...
    void defaultEndpointResolutionLoadsPartitionDataFromClasspath() {
        ...
        try {
            IotDataPlaneEndpointParams params = IotDataPlaneEndpointParams.builder()
            ...
            assertThat(endpoint.url()).isEqualTo(URI.create("https://data-ats.iot.us-east-1.amazonaws.com"));
        } finally {
