...
public class MultiRabbitListenerAnnotationBeanPostProcessorTest {

    @Test
    void suppliesDefaultAdminThroughListenerProxyWhenAnnotationOmitsAdmin() {
    ...
    public static final class ListenerBean {
        ...
        @RabbitListener(id = "multiRabbitCoverageListener", queues = "multi.rabbit.coverage")
    ...
    private static final class CapturingMultiRabbitListenerAnnotationBeanPostProcessor
        ...
        private final Queue declarable = new Queue("multi.rabbit.declarable");
