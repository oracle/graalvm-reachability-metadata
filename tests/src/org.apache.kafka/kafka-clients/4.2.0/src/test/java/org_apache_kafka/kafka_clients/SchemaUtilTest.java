...
public class SchemaUtilTest {
    ...
    @Test
    void schemaInitializationLoadsMapDefaultEntryHolderForDescriptorBasedMapField() {
        assertThat(MapMessageDescriptors.MAP_MESSAGE_DESCRIPTOR.findFieldByName("labels").isMapField()).isTrue();
    ...
    private static final class MapMessageDescriptors {
        private static final Descriptors.Descriptor MAP_MESSAGE_DESCRIPTOR;
        ...
        static {
            try {
                ...
                DescriptorProtos.DescriptorProto mapMessage = DescriptorProtos.DescriptorProto.newBuilder()
                ...
                Descriptors.FileDescriptor fileDescriptor = Descriptors.FileDescriptor.buildFrom(
                    DescriptorProtos.FileDescriptorProto.newBuilder()
                        ...
                        .setSyntax("proto3")
                        .addMessageType(mapMessage)
                        .build(),
                    new Descriptors.FileDescriptor[0]
                );

                MAP_MESSAGE_DESCRIPTOR = fileDescriptor.findMessageTypeByName("SchemaUtilMapMessage");
                LABELS_ENTRY_DESCRIPTOR = MAP_MESSAGE_DESCRIPTOR.findNestedTypeByName("LabelsEntry");
    ...
    public static final class SchemaUtilMapMessage extends GeneratedMessageV3 {
        ...
        public SchemaUtilMapMessage() {
            this.labels_ = MapField.emptyMapField(LabelsDefaultEntryHolder.defaultEntry);
        }
        ...
        public Descriptors.Descriptor getDescriptorForType() {
            return MapMessageDescriptors.MAP_MESSAGE_DESCRIPTOR;
        }
        ...
        private static final class LabelsDefaultEntryHolder {
            private static final MapEntry<String, Integer> defaultEntry = MapEntry.newDefaultInstance(
