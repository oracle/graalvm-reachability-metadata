...
public class UnsafeUtilInnerAndroid64MemoryAccessorTest {
    ...
    private static final MethodHandle ANDROID_64_CONSTRUCTOR_HANDLE = findAndroid64ConstructorHandle();
    ...
    void getStaticObjectReturnsValueOfPublicStaticField() throws Throwable {
        Object accessor = ANDROID_64_CONSTRUCTOR_HANDLE.invokeExact((Unsafe) null);
    ...
    private static MethodHandle findAndroid64ConstructorHandle() {
        try {
            MethodHandles.Lookup unsafeUtilLookup = unsafeUtilLookup();
            Class<?> accessorClass = unsafeUtilLookup.findClass(ANDROID_64_MEMORY_ACCESSOR_CLASS_NAME);
