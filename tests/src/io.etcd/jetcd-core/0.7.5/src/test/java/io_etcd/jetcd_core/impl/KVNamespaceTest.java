...
public class KVNamespaceTest {
    ...
    public void testTxn() throws Exception {
        ...
        Txn firstTxn = kvClientWithNamespace.txn();
        CompletableFuture<TxnResponse> firstTxnFuture = firstTxn
        ...
        TxnResponse firstTxnResponse = firstTxnFuture.get();
        assertThat(firstTxnResponse.getPutResponses().size()).isEqualTo(1);
        assertThat(firstTxnResponse.getPutResponses().get(0).hasPrevKv()).isTrue();
        assertThat(firstTxnResponse.getPutResponses().get(0).getPrevKv().getKey()).isEqualTo(key1);
        assertThat(firstTxnResponse.getPutResponses().get(0).getPrevKv().getValue()).isEqualTo(value1);
        Txn secondTxn = kvClientWithNamespace.txn();
        CompletableFuture<TxnResponse> secondTxnFuture = secondTxn
        ...
        TxnResponse secondTxnResponse = secondTxnFuture.get();
        assertThat(secondTxnResponse.getGetResponses().size()).isEqualTo(1);
        assertThat(secondTxnResponse.getGetResponses().get(0).getKvs().size()).isEqualTo(1);
        assertThat(secondTxnResponse.getGetResponses().get(0).getKvs().get(0).getKey()).isEqualTo(key2);
        assertThat(secondTxnResponse.getGetResponses().get(0).getKvs().get(0).getValue()).isEqualTo(value2);
        Txn thirdTxn = kvClientWithNamespace.txn();
        CompletableFuture<TxnResponse> thirdTxnFuture = thirdTxn
        ...
        TxnResponse thirdTxnResponse = thirdTxnFuture.get();
        assertThat(thirdTxnResponse.getDeleteResponses().size()).isEqualTo(1);
        assertThat(thirdTxnResponse.getDeleteResponses().get(0).getPrevKvs().size()).isEqualTo(1);
        assertThat(thirdTxnResponse.getDeleteResponses().get(0).getPrevKvs().get(0).getKey()).isEqualTo(key2);
        assertThat(thirdTxnResponse.getDeleteResponses().get(0).getPrevKvs().get(0).getValue()).isEqualTo(value2);
    }
