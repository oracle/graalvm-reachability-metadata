...
public class ExtFactoryFinderTest {
    ...
    @Test
    void loadsProviderFromContextClassLoaderServiceResource() throws Exception {
        runWithContextClassLoader(new ServiceProviderClassLoader(), () -> {
            RuntimeDelegate runtimeDelegate = RuntimeDelegate.getInstance();
    ...
    private abstract static class AbstractServiceProviderClassLoader extends ClassLoader {
        private AbstractServiceProviderClassLoader(ClassLoader parent) {
            super(parent);
        }
    ...
    private static final class ServiceProviderClassLoader extends AbstractServiceProviderClassLoader {
        private ServiceProviderClassLoader() {
            super(ExtFactoryFinderTest.class.getClassLoader());
        }
    }

    private static final class SystemFallbackProviderClassLoader extends AbstractServiceProviderClassLoader {
