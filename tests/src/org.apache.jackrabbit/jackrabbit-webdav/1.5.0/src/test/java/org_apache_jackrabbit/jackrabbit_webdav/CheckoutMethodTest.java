...
public class CheckoutMethodTest {
    @Test
    public void constructorCreatesCheckoutRequest() {
        ExposedCheckoutMethod method = new ExposedCheckoutMethod("http://localhost:8080/repository/document.txt");
    ...
    private static final class ExposedCheckoutMethod extends CheckoutMethod {
        private ExposedCheckoutMethod(String uri) {
            super(uri);
        }
