...
public class PutMethodTest {
    @Test
    public void constructorCreatesPutRequest() {
        ExposedPutMethod method = new ExposedPutMethod("http://localhost:8080/repository/document.txt");
    ...
    private static final class ExposedPutMethod extends PutMethod {
        private ExposedPutMethod(String uri) {
            super(uri);
        }
