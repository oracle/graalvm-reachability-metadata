...
public class UtilityElfTest {
    @Test
    void safeIsAssignableFromHandlesPresentAndMissingTypes() {
        ArrayList<String> values = new ArrayList<>();

        assertThat(UtilityElf.safeIsAssignableFrom(values, "java.util.List")).isTrue();
        assertThat(UtilityElf.safeIsAssignableFrom(values, "example.missing.DoesNotExist")).isFalse();
    }

    @Test
    void createInstanceUsesNoArgConstructor() {
    ...
    @Test
    void createInstanceUsesMatchingArgumentConstructor() {
