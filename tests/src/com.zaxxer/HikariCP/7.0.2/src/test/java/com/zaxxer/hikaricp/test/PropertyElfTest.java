...
public class PropertyElfTest {
    ...
    @Test
    void setsIntArrayPropertyFromCommaSeparatedTextValue() {
        MutableBean bean = new MutableBean();
        Properties properties = new Properties();
    ...
    @Test
    void setsStringArrayPropertyFromCommaSeparatedTextValue() {
        MutableBean bean = new MutableBean();
        Properties properties = new Properties();
        properties.setProperty("tags", "alpha,beta\\,with-comma,gamma");

        PropertyElf.setTargetFromProperties(bean, properties);

        assertThat(bean.getTags()).containsExactly("alpha", "beta,with-comma", "gamma");
    }
