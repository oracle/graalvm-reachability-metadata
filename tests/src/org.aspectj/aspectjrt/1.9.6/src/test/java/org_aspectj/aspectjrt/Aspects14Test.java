...
public class Aspects14Test {
    ...
    void obtainsPerObjectAspectAndChecksBinding() {
        ...
        Object aspect = Aspects14.aspectOf(PerObjectAspect.class, boundObject);

        assertThat(aspect).isSameAs(PerObjectAspect.INSTANCE);
        assertThat(Aspects14.hasAspect(PerObjectAspect.class, boundObject)).isTrue();
        assertThat(Aspects14.hasAspect(PerObjectAspect.class, unboundObject)).isFalse();
    }

    @Test
    void obtainsPerTypeWithinAspectAndChecksBinding() {
        Object aspect = Aspects14.aspectOf(PerTypeWithinAspect.class, BoundType.class);

        assertThat(aspect).isSameAs(PerTypeWithinAspect.INSTANCE);
        assertThat(Aspects14.hasAspect(PerTypeWithinAspect.class, BoundType.class)).isTrue();
        assertThat(Aspects14.hasAspect(PerTypeWithinAspect.class, UnboundType.class)).isFalse();
    }
