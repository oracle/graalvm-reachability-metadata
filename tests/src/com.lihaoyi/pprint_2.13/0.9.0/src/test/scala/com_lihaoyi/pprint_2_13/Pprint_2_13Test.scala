 ...
 */
package com_lihaoyi.pprint_2_13
...
class Pprint_2_13Test {
  ...
  def printsCompileTimeTypeRepresentations(): Unit = {
    ...
    val coloredType: fansi.Str = {
      implicit val typeColors: TPrintColors = TPrintColors.Colors.Colored
  ...
  def printsAndLogsThroughPublicConvenienceMethods(): Unit = {
    ...
    assertTrue(plainLoggedOutput.contains("Pprint_2_13Test.scala:"))
