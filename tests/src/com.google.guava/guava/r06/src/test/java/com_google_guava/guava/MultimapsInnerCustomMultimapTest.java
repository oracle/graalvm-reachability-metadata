...
public class MultimapsInnerCustomMultimapTest {
    @Test
    void serializesCustomMultimapFactoryAndBackingMap() throws Exception {
        ...
        Multimap<String, String> copy = roundTrip(original);
        ...
        copy.put("after-deserialization", "created-by-restored-factory");
        assertThat(copy.get("after-deserialization"))
