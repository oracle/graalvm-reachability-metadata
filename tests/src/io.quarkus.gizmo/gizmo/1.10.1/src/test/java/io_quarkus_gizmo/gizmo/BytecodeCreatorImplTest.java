...
public class BytecodeCreatorImplTest {
    @Test
    void createsFunctionalInterfaceImplementation() {
        GeneratedClasses generatedClasses = new GeneratedClasses();

        try (ClassCreator classCreator = ClassCreator.builder()
                .classOutput(generatedClasses)
                .className("io.quarkus.gizmo.generated.FunctionFactory")
                .build()) {
            MethodCreator methodCreator = classCreator.getMethodCreator("create", Runnable.class);

            FunctionCreator functionCreator = methodCreator.createFunction(Runnable.class);
            functionCreator.getBytecode().returnVoid();
            methodCreator.returnValue(functionCreator.getInstance());
        }

        assertGeneratedClass(generatedClasses, "io/quarkus/gizmo/generated/FunctionFactory");
        assertGeneratedClass(generatedClasses, "io/quarkus/gizmo/generated/FunctionFactory$$function$$1");
    }
