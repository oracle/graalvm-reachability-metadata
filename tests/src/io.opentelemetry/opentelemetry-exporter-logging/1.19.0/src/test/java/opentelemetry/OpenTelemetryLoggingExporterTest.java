...
public class OpenTelemetryLoggingExporterTest {

    @Test
    public void loggerSpanExporterTest() {
        TestSpanData span = TestSpanData.builder()
                ...
                .setHasEnded(true)
                .build();
        Assertions.assertTrue(isClassPresent("io.opentelemetry.exporter.logging.LoggingSpanExporter"));

        try (LoggingSpanExporter exporter = LoggingSpanExporter.create()) {
