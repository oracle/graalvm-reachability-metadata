...
public class IOUringSupportTest {
    ...
    @Test
    void reportsUnavailableWhenNativeIoIsDisabled() {
        TransportOptions transportOptions = new TransportOptions().allowNativeIO(false);

        assertThat(IOUringSupport.isAvailable(transportOptions)).isFalse();
    }
}
