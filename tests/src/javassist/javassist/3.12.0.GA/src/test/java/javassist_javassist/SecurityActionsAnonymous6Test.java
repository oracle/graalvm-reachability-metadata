...
public class SecurityActionsAnonymous6Test {
    private static final String BRIDGE_CLASS_NAME = "javassist.util.proxy.SecurityActionsAnonymous6CoverageBridge";
    private static final String SECURITY_ACTION_CLASS_NAME = "javassist.util.proxy.SecurityActions$6";

    @Test
    void privilegedExceptionActionSetsFieldValue() throws Exception {
        try {
            SecurityActionsAnonymous6Probe probe = (SecurityActionsAnonymous6Probe) createBridgeClass().newInstance();
    ...
    private static Class<?> createBridgeClass() throws Exception {
        ...
        classFile.addInterface(SecurityActionsAnonymous6Probe.class.getName());
        ...
        return classPool.toClass(
                bridgeClass,
                SecurityActionsAnonymous6Test.class.getClassLoader(),
                SecurityActionsAnonymous6Test.class.getProtectionDomain());
    }
    ...
    public interface SecurityActionsAnonymous6Probe {
