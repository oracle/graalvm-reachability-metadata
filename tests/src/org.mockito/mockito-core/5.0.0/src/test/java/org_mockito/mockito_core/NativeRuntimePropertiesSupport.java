...
final class NativeRuntimePropertiesSupport {
    ...
    static void restoreMissingRuntimeProperties() {
        ...
        if (!classPath.isBlank() && !classPath.equals(System.getProperty("java.class.path", ""))) {
    ...
    private static Properties loadEmbeddedRuntimeProperties() {
        ...
        try (InputStream inputStream =
                NativeRuntimePropertiesSupport.class.getResourceAsStream("/native-runtime.properties")) {
            if (inputStream != null) {
