...
class ExtensionSchemasTest {
  @Test
  def loadsFullRuntimeSchemaWhenBuildingSchemaForProto2GeneratedMessage(): Unit = {
    ...
    assertNotNull(schemaFor.invokeWithArguments(protobuf, classOf[DescriptorProtos.FileDescriptorSet]))
  }
}
