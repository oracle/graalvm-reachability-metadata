...
public class LauncherTest {
    ...
    void launchInvokesEnhancedMainMethodFromConfiguredRealm() throws Exception {
        ...
        try {
            ...
            ClassLoader realmClassLoader = launcher.getMainRealm().getClassLoader();
            assertThat(EnhancedMain.contextClassLoader).isSameAs(realmClassLoader);
            assertThat(Thread.currentThread().getContextClassLoader()).isSameAs(realmClassLoader);
    ...
    void launchFallsBackToStandardMainMethodFromConfiguredRealm() throws Exception {
        ...
        try {
            ...
            assertThat(StandardMain.contextClassLoader).isSameAs(realmClassLoader);
            assertThat(Thread.currentThread().getContextClassLoader()).isSameAs(realmClassLoader);
