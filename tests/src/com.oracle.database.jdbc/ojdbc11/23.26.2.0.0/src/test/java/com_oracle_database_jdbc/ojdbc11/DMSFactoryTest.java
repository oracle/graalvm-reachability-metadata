...
public class DMSFactoryTest {
    @Test
    void fallsBackWhenDmsClassesAreUnavailable() {
        DMSFactory factory = DMSFactory.getInstance();

        assertThat(factory).isNotNull();
        assertThat(DMSFactory.isDMSEnabled()).isFalse();
        assertThat(DMSFactory.getDMSVersion()).isEqualTo(DMSFactory.DMSVersion.NONE);
