...
public class UnsafeUtilInnerAndroid64MemoryAccessorTest {
    @Test
    void mapDefaultEntryLookupReadsStaticHolderFieldWithAndroid64Accessor() {
        Object defaultEntry = SchemaUtilCoverageSupport.mapDefaultEntry(
                MapDefaultEntryMessage.class,
                "fields");

        assertThat(defaultEntry)
                .isSameAs(MapDefaultEntryMessage.FieldsDefaultEntryHolder.defaultEntry);
