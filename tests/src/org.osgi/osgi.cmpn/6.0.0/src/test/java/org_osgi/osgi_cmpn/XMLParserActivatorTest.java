...
public class XMLParserActivatorTest {
    @TempDir
    Path tempDir;
    ...
    void startInstantiatesConfiguredDocumentBuilderFactoryClass() throws Exception {
        ...
        assertThat(properties.get(XMLParserActivator.PARSER_NAMESPACEAWARE))
    ...
    private static final class TestBundle implements Bundle {
        ...
        public Class<?> loadClass(String name) throws ClassNotFoundException {
            if (TestDocumentBuilderFactory.class.getName().equals(name)) {
                return TestDocumentBuilderFactory.class;
            }
