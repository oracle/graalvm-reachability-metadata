...
import org_springframework.spring_test.TestBeanOverrideHandlerTest_BeanOverrideTestCase__TestContext001_ApplicationContextInitializer;
...
public final class AotTestContextInitializers__Generated {
    ...
    public static Map<String, Supplier<ApplicationContextInitializer<? extends ConfigurableApplicationContext>>> getContextInitializers() {
        ...
        map.put(
                "org_springframework.spring_test.TestBeanOverrideHandlerTest$BeanOverrideTestCase",
                TestBeanOverrideHandlerTest_BeanOverrideTestCase__TestContext001_ApplicationContextInitializer::new);
        return map;
    }
    ...
    public static Map<String, Class<? extends ApplicationContextInitializer<?>>> getContextInitializerClasses() {
        ...
        map.put(
                "org_springframework.spring_test.TestBeanOverrideHandlerTest$BeanOverrideTestCase",
                TestBeanOverrideHandlerTest_BeanOverrideTestCase__TestContext001_ApplicationContextInitializer.class);
        return map;
    }
}
