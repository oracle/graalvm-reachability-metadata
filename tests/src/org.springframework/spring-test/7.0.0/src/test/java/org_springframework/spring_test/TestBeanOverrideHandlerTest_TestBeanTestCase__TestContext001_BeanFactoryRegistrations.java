...
public class TestBeanOverrideHandlerTest_TestBeanTestCase__TestContext001_BeanFactoryRegistrations {
    public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
        ...
        beanFactory.registerBeanDefinition("testBeanOverrideHandlerTest.TestBeanConfiguration",
                TestBeanOverrideHandlerTest__TestContext001_BeanDefinitions.TestBeanConfiguration
                        .getTestBeanConfigurationBeanDefinition());
        ...
        beanFactory.registerBeanDefinition("messageService",
                TestBeanOverrideHandlerTest__TestContext001_BeanDefinitions.TestBeanConfiguration
