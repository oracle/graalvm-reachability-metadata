...
public class TestBeanOverrideHandlerTest_TestBeanTestCase__TestContext001_BeanFactoryRegistrations {
    ...
    public void registerBeanDefinitions(DefaultListableBeanFactory beanFactory) {
        ...
        beanFactory.registerBeanDefinition(
                "testBeanOverrideHandlerTest.GreetingServiceConfiguration",
                TestBeanOverrideHandlerTest__TestContext001_BeanDefinitions.GreetingServiceConfiguration.getGreetingServiceConfigurationBeanDefinition());
        beanFactory.registerBeanDefinition(
        ...
        beanFactory.registerBeanDefinition(
                "greetingService",
                TestBeanOverrideHandlerTest__TestContext001_BeanDefinitions.GreetingServiceConfiguration.getGreetingServiceBeanDefinition());
    }
