...
public final class TestBeanOverrideHandlerTest__TestContext001_BeanDefinitions {
    ...
    public static final class TestConfiguration {
        ...
        /**
         * Get the bean instance supplier for `service`.
         */
        private static BeanInstanceSupplier<TestBeanOverrideHandlerTest.MessageService> getServiceInstanceSupplier() {
            return BeanInstanceSupplier
                    .<TestBeanOverrideHandlerTest.MessageService>forFactoryMethod(TestBeanOverrideHandlerTest.TestConfiguration.class, "service")
        ...
        /**
         * Get the bean definition for `service`.
         */
        public static BeanDefinition getServiceBeanDefinition() {
            ...
            beanDefinition.setInstanceSupplier(getServiceInstanceSupplier());
            return beanDefinition;
        }
    }
}
