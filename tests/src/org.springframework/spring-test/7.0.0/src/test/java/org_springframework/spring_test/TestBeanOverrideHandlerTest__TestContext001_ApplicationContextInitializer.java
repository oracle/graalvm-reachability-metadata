...
public class TestBeanOverrideHandlerTest__TestContext001_ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
    ...
    public void initialize(GenericApplicationContext applicationContext) {
        ...
        TestBeanOverrideHandlerTest__TestContext001_BeanFactoryRegistrations registrations =
                new TestBeanOverrideHandlerTest__TestContext001_BeanFactoryRegistrations();
