...
public class ReflectiveIndexAccessorTest {
    @Test
    void constructsReadOnlyAccessorFromPublicIndexedReadMethod() {
        ...
        assertThat(accessor.getSpecificTargetClasses())
                .containsExactly(FruitMap.class);
    ...
    @Test
    void constructsReadWriteAccessorFromPublicIndexedReadAndWriteMethods() {
