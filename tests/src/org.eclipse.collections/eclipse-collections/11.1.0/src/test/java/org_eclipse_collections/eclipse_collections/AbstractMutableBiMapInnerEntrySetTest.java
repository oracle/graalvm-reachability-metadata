...
public class AbstractMutableBiMapInnerEntrySetTest {
    @Test
    void toArrayCreatesTypedEntryArrayWhenSuppliedArrayIsTooSmall() {
        final HashBiMap<String, Integer> biMap = HashBiMap.newWithKeysValues("alpha", 1, "bravo", 2);
        final Set<Map.Entry<String, Integer>> entrySet = biMap.entrySet();
