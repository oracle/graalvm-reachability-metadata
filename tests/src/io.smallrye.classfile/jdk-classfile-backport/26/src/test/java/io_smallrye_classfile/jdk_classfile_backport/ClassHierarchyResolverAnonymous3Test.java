...
public class ClassHierarchyResolverAnonymous3Test {
    @Test
    void classLoadingResolverResolvesKnownClassWithProvidedClassLoader() {
        ClassHierarchyResolver resolver = ClassHierarchyResolver.ofClassLoading(ClassLoader.getSystemClassLoader());
