...
public class NewProxyPreparedStatementTest {
    @Test
    void rawStatementOperationInvokesMethodOnUnderlyingPreparedStatement() throws Exception {
        ...
        Object rawResult = proxyStatement.rawStatementOperation(
                PreparedStatement.class.getMethod("setString", int.class, String.class),
                C3P0ProxyStatement.RAW_STATEMENT,
                new Object[] {1, "prepared-value"}
        );

        TrackingPreparedStatementHandler preparedStatementHandler =
                nestedDataSource.connectionHandler().preparedStatementHandler();
        assertThat(rawResult).isNull();
        assertThat(preparedStatementHandler.setStringCalls()).isEqualTo(1);
        assertThat(preparedStatementHandler.lastParameterIndex()).isEqualTo(1);
        assertThat(preparedStatementHandler.lastParameterValue()).isEqualTo("prepared-value");
    ...
    private static Connection newConnectionProxy(TrackingConnectionHandler handler) {
        Connection connection = (Connection) Proxy.newProxyInstance(
                NewProxyPreparedStatementTest.class.getClassLoader(),
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws SQLException {
            ...
            switch (name) {
                case "prepareStatement":
                    return newPreparedStatementProxy(connectionProxy, preparedStatementHandler);
    ...
    private static final class TrackingPreparedStatementHandler implements InvocationHandler {
        ...
        public Object invoke(Object proxy, Method method, Object[] args) throws SQLException {
            if (method.getDeclaringClass() == Object.class) {
                return handleObjectMethod(proxy, method, args, "tracking-raw-prepared-statement");
            }
            ...
            switch (name) {
                ...
                case "setString":
                    setStringCalls++;
                    lastParameterIndex = (Integer) args[0];
                    lastParameterValue = (String) args[1];
                    return null;
                case "isClosed":
                    return closed;
                case "close":
