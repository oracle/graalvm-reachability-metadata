...
public class PropertyHandlingAnonymous5Test {

    @Test
    void jdoHandlingInspectsDeclaredFieldsAndMethods() {
        PropertyHandling.Config config = PropertyHandling.JDO.getConfig(QuerydslAnnotatedAccessors.class);
