...
class HttpServletTest {
    ...
    @Test
    void doOptionsInspectsDeclaredMethodsOnServletSubclass() throws Exception {
        RecordingHttpServletResponse response = new RecordingHttpServletResponse();

        new OptionsServlet().invokeDoOptions(response);

        assertEquals("GET, HEAD, POST, TRACE, OPTIONS", response.getHeader("Allow"));
    }

    static final class CustomHttpServlet extends HttpServlet {
    }

    static final class OptionsServlet extends HttpServlet {
        void invokeDoOptions(HttpServletResponse response) throws ServletException, IOException {
            doOptions(null, response);
        }
    ...
    static final class RecordingHttpServletResponse implements HttpServletResponse {
