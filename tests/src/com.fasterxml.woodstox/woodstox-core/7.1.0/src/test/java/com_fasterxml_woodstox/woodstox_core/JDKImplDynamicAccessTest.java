...
public class JDKImplDynamicAccessTest {
    private static final String FACTORY_CLASS_NAME =
            "com.ctc.wstx.shaded.msv_core.datatype.xsd.regex.JDKImpl";

    @Test
    void compilesPatternsThroughTheLegacyJdkRegexpImplementation() throws Exception {
