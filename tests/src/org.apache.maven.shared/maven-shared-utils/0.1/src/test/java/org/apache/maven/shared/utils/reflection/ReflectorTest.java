...
public class ReflectorTest {
    ...
    void createsObjectsUsingMatchingPublicConstructors() throws Exception {
        ...
        Object instance = reflector.newInstance(ReflectorFixture.class, "created");
    ...
    void invokesPublicInstanceStaticAndSingletonMethods() throws Exception {
        ...
        assertThat(reflector.invoke(fixture, "append", "-suffix")).isEqualTo("call-suffix");
        assertThat(reflector.invokeStatic(ReflectorFixture.class, "join", "left", "right")).isEqualTo("left:right");

        Object singleton = reflector.getSingleton(ReflectorFixture.class, "singleton");
