...
./gradlew generatePgoDynamicAccessNearCallReport -Pcoordinates=[group:artifact:version|k/n|all] -PpgoSamplingPeriodMicros=10
...
- Generate PGO near-call dynamic access diagnostics: `./gradlew generatePgoDynamicAccessNearCallReport -Pcoordinates=[group:artifact:version|k/n|all] -PpgoSamplingPeriodMicros=10`
